...
class LoadEventData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $event1 = (new Event())
            ->setName('Захід Фест')
            ->setDescription('<p>Захід &mdash; український щорічний фестиваль сучасного мистецтва, що відбувається з 2009 року на Львівщині. З 2011 року проходить біля села Родатичі Городоцького району.</p><p>Напрямки музики: рок та етно та інші. З 2012 року у фестивалі регулярно беруть участь іноземні виконавці.</p><p>2009 року він відбувся у Звенигороді, 2010 &mdash; у Старосільському замку (з 21 по 23 серпня), а з 2011 року &mdash; на базі відпочинку &laquo;Сонячна долина&raquo; у с. Родатичах за 40 км від Львова, що було пов&#39;язано з очікуванням більшої кількості відвідувачів порівняно з попередніми роками. З 2014 року проводиться на території відпочинкового комплексу &quot;Чарівна долина&quot;</p><p>Мета фестивалю:</p><p>Популяризація української культури.<br />Популяризація серед молоді активного відпочинку та розвиток фестивального руху в Україні.<br />Основною відмінністю від всіх інших фестивалів є те, що фестиваль &laquo;Захід&raquo; проводиться без підтримки спонсорів та політичних, чи будь-яких організацій. Організаторами фестивалю є група молодих ініціативних людей, головний організатор та засновник &mdash; Яків Матвійчук.</p><p><img alt="" src="/images/events/zaxid1.jpg" style="height:250px; width:375px" /><img alt="" src="/images/events/zaxid2.jpg" style="height:250px; width:375px" /><img alt="" src="/images/events/zaxid3.jpg" style="height:250px; width:375px" /><img alt="" src="/images/events/zaxid4.jpg" style="height:250px; width:375px" /></p>')
            ->setCountry('Україна')
            ->setCity('Львів')
